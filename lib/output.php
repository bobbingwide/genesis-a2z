 ...
 * Genesis A2Z.
 *
 * This file adds the required CSS to the front end to the Genesis A2Z Theme.
 *
 * @package Genesis A2Z
 * @author  bobbingwide
...
add_action( 'wp_enqueue_scripts', 'genesis_a2z_css' );
/**
...
function genesis_a2z_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'genesis_a2z_logo_width', 350 );
