 ...
 * Genesis A2Z.
 *
 * This file adds the Customizer additions to the Genesis A2Z Theme.
 *
 * @package Genesis A2Z
 * @author  bobbingwide
...
add_action( 'customize_register', 'genesis_a2z_customizer_register' );
/**
 ...
 */
function genesis_a2z_customizer_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'section'     => 'colors',
				'settings'    => 'genesis_a2z_link_color',
			)
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			array(
				...
				'section'     => 'colors',
				'settings'    => 'genesis_a2z_accent_color',
			)
		)
	);

	$wp_customize->add_setting(
		'genesis_a2z_logo_width',
		array(
			'default'           => 350,
	...
	$wp_customize->add_control(
		...
		array(
			...
			'settings'    => 'genesis_a2z_logo_width',
			'type'        => 'number',
			'input_attrs' => array(
				'min' => 100,
			),
