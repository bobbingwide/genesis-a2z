 ...
 * Genesis A2Z.
 *
 * This file adds the required helper functions used in the Genesis A2Z Theme.
 *
 * @package Genesis A2Z
 * @author  bobbingwide
 ...
 */
function genesis_a2z_color_contrast( $color ) {
 ...
 */
function genesis_a2z_color_brightness( $color, $change ) {
