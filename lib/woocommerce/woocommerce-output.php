 ...
 * Genesis A2Z.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the Genesis A2Z Theme.
 *
 * @package Genesis A2Z
 * @author  bobbingwide
...
add_filter( 'woocommerce_enqueue_styles', 'genesis_a2z_woocommerce_styles' );
/**
 ...
 */
function genesis_a2z_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'genesis_a2z_woocommerce_css' );
/**
 ...
 */
function genesis_a2z_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'genesis_a2z_link_color', $appearance['default-colors']['link'] );
	$color_accent = get_theme_mod( 'genesis_a2z_accent_color', $appearance['default-colors']['accent'] );
	...
	',
		$color_accent,
		genesis_a2z_color_contrast( $color_accent )
	) : '';
