 ...
 * Genesis A2Z.
 *
 * This file adds the required WooCommerce setup functions to the Genesis A2Z Theme.
 *
 * @package Genesis A2Z
 * @author  bobbingwide
...
add_filter( 'woocommerce_style_smallscreen_breakpoint', 'genesis_a2z_woocommerce_breakpoint' );
/**
 ...
 */
function genesis_a2z_woocommerce_breakpoint() {
...
add_filter( 'genesiswooc_products_per_page', 'genesis_a2z_default_products_per_page' );
/**
 ...
 */
function genesis_a2z_default_products_per_page() {

	return 8;

}

add_filter( 'woocommerce_pagination_args', 'genesis_a2z_woocommerce_pagination' );
/**
 ...
 */
function genesis_a2z_woocommerce_pagination( $args ) {
...
add_action( 'after_switch_theme', 'genesis_a2z_woocommerce_image_dimensions_after_theme_setup', 1 );
/**
 * Defines WooCommerce image sizes on theme activation.
 *
 * @since 2.3.0
 */
function genesis_a2z_woocommerce_image_dimensions_after_theme_setup() {
	...
	genesis_a2z_update_woocommerce_image_dimensions();

}

add_action( 'activated_plugin', 'genesis_a2z_woocommerce_image_dimensions_after_woo_activation', 10, 2 );
/**
 ...
 */
function genesis_a2z_woocommerce_image_dimensions_after_woo_activation( $plugin ) {
 ...
 * @since 2.3.0
 */
function genesis_a2z_update_woocommerce_image_dimensions() {
...
add_filter( 'woocommerce_get_image_size_gallery_thumbnail', 'genesis_a2z_gallery_image_thumbnail' );
/**
 ...
 */
function genesis_a2z_gallery_image_thumbnail( $size ) {
